...
def display():
    try:
        ...
        for (SRno,model,body_type,fuel_type,price,acceleration,top_speed) in cursor:
            print("----------------------------------------------------------------------")
            print('SRno                              :',SRno)
            print('model                             :',model)
...
def insertdata():
    try:
        ...
        sql='insert into bmw values(%s,%s,%s,%s,%s,%s,%s)'
        values=(SRno,model,body_type,fuel_type,price,acceleration,top_speed)
...
def deletedata():
     try:
        ...
        query='delete from bmw where SRno=%s'
        del_rec=(SRno,)
...
def search():
    try:
        ...
        cursor=cnx.cursor()
        SRno=int(input('enter serial number'))
        query=('select*from bmw where SRno=%s')
        rec_srch=(SRno,)
...
def update():
    try:
        ...
        acceleration=float(input('enter acceleration:'))
        top_speed=int(input('enter top speed:'))
        query='update bmw set SRno=%s,Model=%s,Bodytype=%s,Fueltype=%s,Price=%s,Acceleration=%s,topspeed=%s where SRno=%s'
        data=(SRno1,model,body_type,fuel_type,price,acceleration,top_speed,SRno)
